...
WEB_WEBS_SCRIPT="$SCRIPT_DIR/web1_webs.sh"
WEB_ENTRY_SCRIPT="$SCRIPT_DIR/web1_entry_nginx.sh"
WEB_CERT_SCRIPT="$SCRIPT_DIR/web1_cert_nginx.sh"
...
echo -e "${YELLOW}Running 0web.sh v05${NC}"
