...
|       `-- [2/2] ai/bai1_build_router_service.sh v04
...
|           `-- list available router models through llama_control.sh or raw API fallback
|-- [2/3] ai/bai1_init_model_cache.sh v02
...
|       |-- use LLAMA_CONTROL_SCRIPT or ai/llama_control.sh
